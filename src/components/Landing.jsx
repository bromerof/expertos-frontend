...
function Landing() {
  ...
  const handleOpinion = () => {
    window.open('https://forms.gle/YJQwiFRpUWrnSRNv8', '_blank')
  }
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#2C3E50] px-6 py-4 flex flex-wrap justify-between items-center gap-4">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <Link
            to="/login"
            className="px-4 py-2 border border-white text-white rounded font-bold cursor-pointer hover:bg-white hover:text-[#2C3E50]"
          >
            Iniciar sesión
          </Link>
          <Link
          ...
          <button
            ...
            className="text-white underline text-sm cursor-pointer hover:text-gray-300"
          >
