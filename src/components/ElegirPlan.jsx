  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-6 max-w-2xl mx-auto">
        <h2 className="text-2xl font-bold text-[#2C3E50] mb-1 text-center">¿Con que plan quieres empezar?</h2>
        <p className="text-gray-500 mb-8 text-center">
          Puedes cambiar de plan cuando quieras despues de registrarte.
        </p>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-300 rounded p-6 flex flex-col">
            ...
            <ul className="text-sm text-gray-700 list-disc list-inside space-y-2 mb-6 flex-1">
              <li>Perfil publico con tu profesion</li>
              <li>Apareces en las busquedas</li>
          ...
          <div className="bg-[#2C3E50] rounded p-6 flex flex-col text-white relative">
            ...
            <ul className="text-sm list-disc list-inside space-y-2 mb-6 flex-1">
              <li>Todo lo del plan Free, y ademas:</li>
              ...
              <li>Estadisticas de vistas, contactos y busquedas</li>
            </ul>
            <Link
